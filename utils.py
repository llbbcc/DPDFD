...
def DPTrain(images, teacher, student, criterion, criterion_s, lr_gamma, clipping='auto', c=1e-4, e=0.001, sigma=100, batch_size=256, multiT=False, n_teachers=None, teachers=None):
    '''
    :param images: synthetic data (generated by generator in our case)
    :param teacher: teacher model
    :param student: student model
    :param criterion: loss function (MSE in our case)
